...
sudo apt install \
  agnocast-kmod-v2.4.0 \
  agnocast-heaphook-v2.4.0
```
...
!!! note "Versioning rules"
    ...
    Packages use version-pinned names (e.g., `agnocast-kmod-v2.4.0`) to ensure all components are at exactly the same version.
