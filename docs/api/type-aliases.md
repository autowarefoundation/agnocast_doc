...
| `agnocast::Service<ServiceT>` | `agnocast::BasicService<ServiceT>` | The user-facing Agnocast service server. Alias for BasicService<ServiceT>. Use this type (not BasicService directly) when declaring service server variables. |
