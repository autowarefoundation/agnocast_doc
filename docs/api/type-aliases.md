...
| `agnocast::Service<MessageT>` | `BasicService<ServiceT, RosToAgnocastServiceRequestPolicy>` | The user-facing Agnocast service server. Alias for BasicService<ServiceT> . Use this type (not BasicService directly) when declaring service server variables. |
