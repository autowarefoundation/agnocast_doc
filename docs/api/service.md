...
**Extends:** `std::enable_shared_from_this< BasicService< ServiceT, BridgeRequestPolicy > >`
...
```cpp
void BasicService::send_response(agnocast::ipc_shared_ptr<typename ServiceT::Request> &&request, agnocast::ipc_shared_ptr<typename ServiceT::Response> &&response)
```
...
```cpp
agnocast::ipc_shared_ptr<typename ServiceT::Response> BasicService::borrow_loaned_response(agnocast::ipc_shared_ptr<typename ServiceT::Request> &request)
```
